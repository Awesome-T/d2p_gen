  ...
  static Pioijh fromDTO (DTOPioijh model) {
    try {
      return Pioijh(
          ...
          List<Blah>.from(model.smthn!.map<Blah>((model)=>Blah (id : model.id,tags : model.tags,price : model.price,isVerifyed : model.isVerifyed,settings : jsonDecode(model.settings) as Map<String,double>,count : model.count,),),):
          [],
                             model.age,
        );
  ...
  static DTOPioijh toDTO (Pioijh model){
    try {
      return DTOPioijh(
          ...
          List<DTOBlah>.from(model.smthn!.map<DTOBlah>((model)=>DTOBlah (id  : model.id,tags  : model.tags,price  : model.price,isVerifyed  : model.isVerifyed,settings  : jsonEncode(model.settings),count  : model.count,),),):
          [],
          age : model.age,
        );
} on FormatException catch (e, trace) {
  ...
  static Person fromDTO (DTOPerson model) {
    try {
      return Person(
          ...
          List<Blah>.from(model.blahs!.map<Blah>((model)=>Blah (id : model.id,tags : model.tags,price : model.price,isVerifyed : model.isVerifyed,settings : jsonDecode(model.settings) as Map<String,double>,count : model.count,),),):
          [],
        );
} on FormatException catch (e, trace) {
    throw FormatException(
  ...
  static DTOPerson toDTO (Person model){
    try {
      return DTOPerson(
          ...
          blahs : (model.blahs?.isNotEmpty??false)?
          List<DTOBlah>.from(model.blahs!.map<DTOBlah>((model)=>DTOBlah (id  : model.id,tags  : model.tags,price  : model.price,isVerifyed  : model.isVerifyed,settings  : jsonEncode(model.settings),count  : model.count,),),):
          [],
        );
} on FormatException catch (e, trace) {
    throw FormatException(
